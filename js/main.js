...
/* harmony import */ var _components_choices_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/choices.js */ "./src/js/components/choices.js");
/* harmony import */ var _components_choices_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_choices_js__WEBPACK_IMPORTED_MODULE_0__);
...
var template = function (data) {
  ...
  if (!data.element)
    // подавляем вызов для поля поиска
...
// const choices = new Choices('[data-select]', {
// callbackOnInit: () => {
//   item1 = document.querySelector('[data-id="1"]')
//   let item2 = document.querySelector('[data-id="2"]')
//   item1.innerHTML = '<img src="./img/canada1.svg">';
//   item2.innerHTML = '<img src="./img/flag.svg">';
//   console.log(item1)
//   console.log(item2)
...
const deep = structuredClone(rules1);
// console.log(deep)
// console.log(deep[1] === rules1[1])
...
forms.forEach(el => {
  (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)(el, rules1, afterForm);
});

// validateForms('.certification .form', rules1, afterForm);

// validateForms('.employment .form', rules1, afterForm);

// validateForms('.call .form', rules1, afterForm);
...
const validateForms = (selector, ruless, afterSend) => {
  const rules = structuredClone(ruless);
  // const form = document?.querySelector(selector);
  const form = selector;
  // console.log(form)
  const telSelector = form?.querySelector('input[type="tel"]');
  // const telSelector = this.querySelector('input[type="tel"]');
  ...
  if (telSelector) {
    const inputMask = new (inputmask__WEBPACK_IMPORTED_MODULE_1___default())('(506) 234 9999', {
      "placeholder": "X"
    });
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        if (xhr.status === 200) {
          ...
          form.querySelector('.form-message-wrong').classList.add('show');
        }
      }
    };
