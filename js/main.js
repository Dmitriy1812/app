...
/* harmony import */ var _components_itl_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/itl.js */ "./src/js/components/itl.js");
...
const iti = intl_tel_input__WEBPACK_IMPORTED_MODULE_0___default()(input, {
  nationalMode: false,
  // nationalMode: true,
  // dropdownContainer: customDropdown,
  ...
  //   // return "e.g. " + JSON.stringify(selectedCountryData);
  // },
...
const handleChange = () => {
  ...
  if (input.value) {
    text = iti.isValidNumber() ? "Valid number! Full international format: " + iti.getNumber() : "Invalid number - please try again";
...
const dropdownParent = document.querySelector(".iti--allow-dropdown");
const dropdown = dropdownParent.querySelector(".iti__country-list");
new ResizeObserver(() => dropdown.style.width = dropdownParent.offsetWidth + 'px').observe(dropdownParent);
...
new simplebar__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementById('iti-0__country-listbox'));
...
// import { number } from '../components/itl.js';
// console.log(number);
...
const validateForms = (selector, ruless, afterSend) => {
  ...
  if (telSelector) {
    // const inputMask = new Inputmask('(506) 234 9999',{ "placeholder": "X" });
      ...
      if (item.tel) {
        ...
        item.rules.push({
          ...
          validator: function () {
            ...
            const phone = telSelector.value;
            let phoneNumbers = phone.replace('+', '');
            // let number = phone.length;
            console.log(telSelector.value);
